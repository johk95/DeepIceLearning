...
def parseArguments():
    ...
    parser.add_argument("--date", help="Give date to identify safe folder", type=str, default = 'None')
...
if args['continue'] != 'None':
    ...
    if '--testing' in arguments:
        try:
            shutil.copy(os.path.join(file_location,folders[2],'condor.out'), os.path.join(file_location,folders[2],'condor.out.training'))
